...
class GettingDressedStageTwo extends StatefulWidget {
  @override
  GettingDressedPg createState() => GettingDressedPg();
  
}


class GettingDressedPg extends State<GettingDressedStageTwo>{
  double percent = 0.0;
  ...
  void initState() {
    ...
    Widget build(BuildContext context) {
        ...
        appBar: AppBar(
          backgroundColor: Colors.cyan[600],
          toolbarHeight: 70,
          title: Text("Let's get Dressed!", style: TextStyle(fontSize: 26.0, fontFamily: 'Bubbly')),
  ...
  children: <Widget>[
    ...
    Container(
      ...
      child: Text("Let's get dressed, remember your shirt, pants, and socks!", style: TextStyle(color: Colors.white, fontFamily: 'BubblegumSans', fontSize: 40),),
    ),
  ],
),
);
