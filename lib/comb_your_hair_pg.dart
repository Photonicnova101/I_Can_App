...
class CombHairStageTwo extends StatefulWidget {
  @override
  CombHairPg createState() => CombHairPg();
  
}


class CombHairPg extends State<CombHairStageTwo>{
  double percent = 0.0;
  ...
  void initState() {
    ...
    Widget build(BuildContext context) {
        ...
        appBar: AppBar(
          backgroundColor: Colors.cyan[600],
          toolbarHeight: 70,
          title: Text("Let's Comb our Hair!", style: TextStyle(fontSize: 26.0, fontFamily: 'Bubbly')),
  ...
  children: <Widget>[
    ...
    Container(
      ...
      child: Text("Let's comb our hair, get rid of that bed hair and fuzz!", style: TextStyle(color: Colors.white, fontFamily: 'BubblegumSans', fontSize: 40),),
    ),
  ],
),
);
