...
class MakeBedStageTwo extends StatefulWidget {
  @override
  MakeBedPg createState() => MakeBedPg();
  
}


class MakeBedPg extends State<MakeBedStageTwo>{
  double percent = 0.0;
  ...
  void initState() {
    ...
    Widget build(BuildContext context) {
        ...
        appBar: AppBar(
          backgroundColor: Colors.cyan[600],
          toolbarHeight: 70,
          title: Text("Let's Make our Bed!", style: TextStyle(fontSize: 26.0, fontFamily: 'Bubbly')),
  ...
  children: <Widget>[
    ...
    Container(
      ...
      child: Text("Let's Make our bed, it should take 2 minutes if we're quick about it!", style: TextStyle(color: Colors.white, fontFamily: 'BubblegumSans', fontSize: 40),),
    ),
  ],
),
);
